...
public class RVsensor implements SensorEventListener
{
    ...
    public RVsensor(Context context)
    {
    ...
    public Boolean Start()
    {
        try
        {
            ...
            mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ROTATION_VECTOR);// TYPE_GRAVITY
