...
public class Luxsenor implements SensorEventListener
{
    ...
    public Luxsenor(Context context)
    {
    ...
    public Boolean Start()
    {
        try
        {
            ...
            mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_LIGHT );// TYPE_GRAVITY
