...
public class Tsensor  implements SensorEventListener
{
    ...
    public Tsensor(Context context)
    {
    ...
    public Boolean Start()
    {
        try
        {
            ...
            mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_TEMPERATURE);// TYPE_GRAVITY
