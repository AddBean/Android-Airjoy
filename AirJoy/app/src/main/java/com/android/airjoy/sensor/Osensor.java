...
public class Osensor implements SensorEventListener
{
    ...
    public Osensor(Context context)
    {
    ...
    public Boolean Start()
    {
        try
        {
            ...
            mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION );// TYPE_GRAVITY
